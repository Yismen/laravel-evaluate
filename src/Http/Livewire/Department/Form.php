...
class Form extends Component
{
    ...
    {
        return view('evaluate::livewire.department.form')
    ...
    public function store()
    {
        ...
        evaluateFlash('Department created!', 'success');
    }
    ...
    public function update()
    {
        ...
        evaluateFlash('Department updated!', 'success');
    }
    ...
    protected function getRules()
    {
        return [
            'department.name' => [
                'required',
                Rule::unique(evaluateTableName('departments'), 'name')->ignore($this->department->id ?? 0)
            ],
