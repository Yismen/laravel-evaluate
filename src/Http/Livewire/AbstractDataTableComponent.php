...
namespace Dainsys\Evaluate\Http\Livewire;
...
abstract class AbstractDataTableComponent extends DataTableComponent
{
    ...
    public function configure(): void
    {
        ...
        $this->setRefreshTime(config('evaluate.polling_miliseconds'));
    ...
    {
        return str($this->module)->headline()->plural() . ' ' . __('evaluate::messages.table');
    }
}
