...
use Dainsys\Evaluate\Http\Livewire\Department\Form;
...
class FormTest extends TestCase
{
    ...
    /** @test */
    public function department_form_component_grants_access_to_evaluate_super_admin_to_create_department()
    {
    ...
    /** @test */
    public function department_form_component_grants_access_to_evaluate_super_admin_to_update_department()
    {
        $this->actingAs($this->evaluateSuperAdminUser());
        $department = Department::factory()->create();
