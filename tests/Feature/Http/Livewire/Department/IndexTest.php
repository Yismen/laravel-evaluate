...
use Dainsys\Evaluate\Http\Livewire\Department\Index;
...
class IndexTest extends TestCase
{
    ...
    public function departments_index_works_for_authorized_users_and_renders_correct_view()
    {
        ...
        $component->assertOk();
        $component->assertViewIs('evaluate::livewire.department.index');
    }

    /** @test */
    public function departments_index_works_for_evaluate_super_admin_users_and_renders_correct_view()
    {
        $this->actingAs($this->evaluateSuperAdminUser());
