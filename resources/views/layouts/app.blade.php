...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ mix('css/app.css', 'vendor/dainsys/evaluate') }}">
    @livewireStyles
    <style>
        [x-cloak] {
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="left: inherit; right: 0px;">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="{{ route('logout') }}" class="dropdown-item"
                                ...
                                {{ str(__('evaluate::messages.log_out'))->headline() }}
                            </a>
                        </form>
                    </div>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{ Route::has('home') ? route('home') : '/' }}" class="brand-link text-center text-uppercase">
                {{-- <img src="{{ asset('images/logo.png') }}" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8"> --}}
                <span class="brand-text font-weight-light">{{ config('app.name', 'Dainsys Evaluate') }}</span>
            </a>

            @include('evaluate::layouts.navigation')
        </aside>
    ...
    <script src="{{ mix('js/app.js', 'vendor/dainsys/evaluate') }}"></script>
